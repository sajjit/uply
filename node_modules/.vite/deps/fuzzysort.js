  ...
  "node_modules/fuzzysort/fuzzysort.js"(exports, module) {
    ((root, UMD) => {
      ...
      var go = (search, targets, options) => {
        if (!search) return (options == null ? void 0 : options.all) ? all(targets, options) : noResults;
        var preparedSearch = getPreparedSearch(search);
        var searchBitflags = preparedSearch.bitflags;
        var containsSpace = preparedSearch.containsSpace;
        var threshold = denormalizeScore((options == null ? void 0 : options.threshold) || 0);
        var limit = (options == null ? void 0 : options.limit) || INFINITY;
        var resultsLen = 0;
        var limitedCount = 0;
        ...
        if (options == null ? void 0 : options.key) {
        ...
        } else if (options == null ? void 0 : options.keys) {
          ...
          outer: for (var i = 0; i < targetsLen; ++i) {
            ...
            if (options == null ? void 0 : options.scoreFn) {
      ...
      var remove_accents = (str) => str.replace(new RegExp("\\p{Script=Latin}+", "gu"), (match) => match.normalize("NFD")).replace(/[\u0300-\u036f]/g, "");
